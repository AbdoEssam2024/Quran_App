...
import 'package:quran/controller/bestreading/bestreadingplayscreencontroller.dart';
                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: TextButton.icon(
                                ...
                                onPressed: () {
                                  controller.goToBestReadingScreen();
                                },
                                icon: Icon(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      BestReadingText(
                                          text:
                                              "${controller.index + 1} / ${controller.videosUrl.length}",
                                          size: 14.sp),
                                    ],
                                  ),
                                ),
                                Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      top: ScreenSize.screenHeight * 0.25,
                                      child: AnimatedOpacity(
                                          duration: Duration(milliseconds: 500),
                                          opacity: controller.showPlayIcon
                                              ? 1.0
                                              : 0.0,
