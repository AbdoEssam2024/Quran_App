...
class VariousReadingController extends GetxController {
  ...
  // Injection Of (VariousReading) Class To Get All (Qarea Data) From The Server ; //
  ...
  getData() async {
    ...
    if (statusRequest == StatusRequest.success) {
      // Add The (response['reads']) To The List (data) , //
      data.addAll(response['reads']);
  ...
  gotoSuwarAudio(int index) {
    Get.toNamed(AppRoutesNames.variousreadingSuwar,
