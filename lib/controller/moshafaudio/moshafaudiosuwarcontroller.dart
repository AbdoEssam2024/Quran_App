...
class MoshafAudioSuwarController extends GetxController {
  ...
  goToPlayScreen(int index) {
    Get.toNamed(AppRoutesNames.moshafplayscreen,
  ...
  goToMoshafAudio() {
    ...
    Get.delete<MoshafAudioSuwarController>();
  }
